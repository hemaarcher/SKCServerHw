...
import styles from './ArcherSerHwSysListWp.module.scss';
import { IArcherSerHwSysListWpState, SystemsItem } from './IArcherSerHwSysListWpState';
import { IArcherSerHwSysListWpProps } from './IArcherSerHwSysListWpProps';
...
export default class ArcherSerHwSysListWp extends React.Component<IArcherSerHwSysListWpProps, IArcherSerHwSysListWpState> {
  constructor(props: IArcherSerHwSysListWpProps, state: IArcherSerHwSysListWpState) {
  ...
  public render(): React.ReactElement<IArcherSerHwSysListWpProps> {
    return (
      <div className={ styles.archerSerHwSysListWp }>
